...
class MonthlyRegistrationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final titleOsw20Bold500Secondary = Theme.of(
      context,
    ).textTheme.titleOsw20Bold500Secondary;
      ...
      child: Column(
        children: [
            ...
            children: [
              SizedBox(
                ...
                child: CircularProgressIndicator(
                  value: (ausenciasPermitidas > 0)
                      ? (1.0 - (ausencias / ausenciasPermitidas))
                      : 1.0,
                  strokeWidth: 4,
              ...
              SizedBox(
                ...
                child: CircularProgressIndicator(
                  value: (totalVacaciones > 0)
                      ? (1 - (vacaciones / totalVacaciones))
                      : 1.0,
                  strokeWidth: 4,
              ...
              SizedBox(
                ...
                child: CircularProgressIndicator(
                  ...
                  value: (asistenciasMensuales > 0)
                      ? (1.0 - (asistencia / asistenciasMensuales))
                      : 1.0,
                  strokeWidth: 4,
          ...
          Column(
            ...
            children: [
              TotalStatus(
                cant: asistencia.toInt(),
                type: 'Asistencia',
                color: Color(0xFF7e9758),
              ),
              TotalStatus(
                cant: vacaciones.toInt(),
                type: 'Vacaciones',
                color: kColorVacaciones,
              ),
              TotalStatus(
                cant: ausencias.toInt(),
                type: 'Ausencia',
                color: kColorFalta,
              ),
            ],
...
class TotalStatus extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final textJt12bold400Secondary = Theme.of(
      context,
    ).textTheme.textJt12bold400Secondary;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            '$cant',
            style: textJt12bold400Secondary.copyWith(
              color: color,
              fontSize: 12 * fontSizedGrow,
            ),
          ),
          const SizedBox(width: 5),
          Text(
            type,
            style: textJt13bold400Secondary.copyWith(
